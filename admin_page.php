...
<body>
    ...
    <section class="dashboard">
      ...
      <div class="box">
         <?php
            $total_completes = 0;
            $select_completes = mysqli_query($conn, "SELECT * FROM `orders` WHERE payment_status = 'completed'") or die(mysqli_error($conn));
      ...
      <div class="box">
         <?php
            $select_admin = mysqli_query($conn, "SELECT * FROM `users` WHERE user_type = 'admin'") or die(mysqli_error($conn));
            $number_of_admin = mysqli_num_rows($select_admin);
         ?>
         <h3><?php echo $number_of_admin; ?></h3>
         <p>Admin</p>
         <a href="" class="btn" >See admin</a>
      </div>
      ...
      <div class="box">
         ...
         <p>Total accounts</p>
         <a href="admin_users.php" class="btn" >See Total Accounts</a>
      </div>
