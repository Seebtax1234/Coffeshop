...
<section class="checkout-orders">
   ...
   <form action="" method="POST">
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            <span>City :</span>
            <input type="text" name="city" placeholder="e.g. Manila" class="box" >
         </div>
         <div class="inputBox">
            <span>State:</span>
            <input type="text" name="state" placeholder="e.g. Region 1" class="box" >
         </div>
         <div class="inputBox">
            <span>Country :</span>
         ...
         <div class="inputBox">
            <span>Pin Code :</span>
            <input type="number" min="0" name="pin_code" placeholder="e.g. 123456" class="box" >
         </div>
      </div>
